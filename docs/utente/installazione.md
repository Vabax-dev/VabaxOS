...
- **La cifratura del disco, per ora, sconsigliata.** Quando l'installer chiede come dividere il disco, tra le scelte c'è anche «Guidato - usa l'intero disco e imposta LVM cifrato», dell'installer di Debian. Funziona, ma a ogni avvio il computer chiede la password del disco **senza voce e senza segnale**: bisogna sapere che sta aspettando, scriverla alla cieca e premere Invio. La richiesta con voce, segnale sonoro e Braille arriva con la v0.3 ([ADR-0021](../decisions/0021-firewall-e-cifratura.md)); fino ad allora conviene scegliere «Guidato - usa l'intero disco».
