...
class WelcomeTest(unittest.TestCase):
    ...
    def test_voice_and_keyboard(self):
        w = Welcome()
        # English; Voice and keyboard; Faster voice twice; Keyboard; Back; Try.
        w.press(ENTER, DOWN, ENTER, DOWN, ENTER, ENTER, DOWN, ENTER, DOWN, ENTER, ENTER)
        code, log = w.finish()
        self.assertEqual(code, 0)
