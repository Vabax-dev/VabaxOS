...
- Prove finali della notte (ISO completa blocchi 3-6, 2026-09-25 05:42): `test-boot.sh` voce passato (Kokoro con Orca, menu Start 0 comandi senza nome, File e Terminale 0, sospensione, suoni, font); `test-install.sh` passato in tutti i controlli (installazione in 4-5 minuti, benvenuto al primo avvio udibile e segnato, schermata di accesso che parla dopo Tab, voce della console anche senza rete, benvenuto non ripetuto). CI su GitHub: #8, #9 e #11 verdi; #10 con un solo controllo fallito (spegnimento lento, 91 s, in modalità di recupero), da verificare.
