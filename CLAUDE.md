...
- Da decidere con Vabax: ADR-0020, ADR-0021; se segnalare a Debian e ad ArcMenu i difetti trovati.
- Prossimo: ascolto di Vabax dei blocchi 3-8 e merge in ordine (#8 → #13); prova su PC fisico; repository APT VabaxOS (v0.2).
